...
public class TestMyDate {
    public static void main(String[] args) {
        ...
        System.out.println(date4.nextDay()); // Wednesday 29 Feb 2012
        System.out.println(date4.nextDay()); // Thursday 1 Mar 2012
        System.out.println(date4.nextMonth()); // Sunday 1 Apr 2012
        System.out.println(date4.nextYear());
        MyDate date5 = new MyDate(2011, 2, 29); // Invalid year, month, or day!
        System.out.println(date5.nextDay()); // Wednesday 29 Feb 2012
        System.out.println(date5.nextDay()); // Thursday 1 Mar 2012
        System.out.println(date5.nextMonth()); // Sunday 1 Apr 2012
        System.out.println(date5.nextYear());
    }
}
